IPWS as a project, including go-ipfs and all of its modules, follows the [standard IPWS Community contributing guidelines](https://github.com/ipfs/community/blob/master/CONTRIBUTING.md).
