...
| **Repo** |
| [`go-ipws-config`](//github.com/ipweb-group/go-ipws-config) | [![Travis CI](https://travis-ci.com/ipweb-group/go-ipws-config.svg?branch=master)](https://travis-ci.com/ipweb-group/go-ipws-config) | [![codecov](https://codecov.io/gh/ipweb-group/go-ipws-config/branch/master/graph/badge.svg)](https://codecov.io/gh/ipweb-group/go-ipws-config) | go-ipfs config file definitions |
