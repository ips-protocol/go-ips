...
var SwarmCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws swarm' is a tool to manipulate the network swarm. The swarm is the
component that opens, listens for, and maintains connections to other
ipws peers in the internet.
`,
	},
...
var swarmPeersCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws swarm peers' lists the set of peers this node is connected to.
`,
	},
	Options: []cmds.Option{
...
var swarmAddrsCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws swarm addrs' lists all addresses this node is aware of.
`,
	},
	Subcommands: map[string]*cmds.Command{
...
var swarmAddrsLocalCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws swarm addrs local' lists all local listening addresses announced to the network.
`,
	},
	Options: []cmds.Option{
...
var swarmAddrsListenCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws swarm addrs listen' lists all interface addresses the node is listening on.
`,
	},
	Run: func(req *cmds.Request, res cmds.ResponseEmitter, env cmds.Environment) error {
		api, err := cmdenv.GetApi(env, req)
...
var swarmConnectCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws swarm connect' opens a new direct connection to a peer address.

The address format is an IPWS multiaddr:

ipws swarm connect /ip4/104.131.131.82/tcp/4001/ipfs/QmaCpDMGvV2BGHeYERUEnRQAwe3N8SzbUtfsmvsqQLuvuJ
`,
	},
...
var swarmDisconnectCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws swarm disconnect' closes a connection to a peer address. The address
format is an IPWS multiaddr:

ipws swarm disconnect /ip4/104.131.131.82/tcp/4001/ipfs/QmaCpDMGvV2BGHeYERUEnRQAwe3N8SzbUtfsmvsqQLuvuJ

The disconnect is not permanent; if ipws needs to talk to that address later,
it will reconnect.
`,
	},
	Arguments: []cmds.Argument{
...
func resolveAddresses(ctx context.Context, addrs []string) ([]ma.Multiaddr, error) {
	...
	for _, addr := range addrs {
		...
		go func(maddr ma.Multiaddr) {
			...
			if found == 0 {
				resolveErrC <- fmt.Errorf("found no ipws peers at %s", maddr)
			}
		}(maddr)
	}
	go func() {
...
var swarmFiltersCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws swarm filters' will list out currently applied filters. Its subcommands
...
var swarmFiltersAddCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws swarm filters add' will add an address filter to the daemons swarm.
Filters applied this way will not persist daemon reboots, to achieve that,
add your filters to the ipws config file.
`,
	},
	Arguments: []cmds.Argument{
...
var swarmFiltersRmCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws swarm filters rm' will remove an address filter from the daemons swarm.
Filters removed this way will not persist daemon reboots, to achieve that,
remove your filters from the ipws config file.
`,
	},
	Arguments: []cmds.Argument{
