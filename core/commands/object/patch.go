...
var ObjectPatchCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		...
		ShortDescription: `
'ipws object patch <root> <cmd> <args>' is a plumbing command used to
...
Example:
	...
	$ echo "hello" | ipws object patch $HASH append-data
...
var patchSetDataCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		Tagline: "Set the data field of an IPWS object.",
		ShortDescription: `
Set the data of an IPWS object from stdin or with the contents of a file.

Example:

    $ echo "my data" | ipws object patch $MYHASH set-data
`,
	},
	Arguments: []cmds.Argument{
		cmds.StringArg("root", true, false, "The hash of the node to modify."),
...
Example:
    ...
    $ EMPTY_DIR=$(ipws object new unixfs-dir)
    $ BAR=$(echo "bar" | ipws add -q)
    $ ipws object patch $EMPTY_DIR add-link foo $BAR
...
`,
	...
	Arguments: []cmds.Argument{
		...
		cmds.StringArg("ref", true, false, "IPWS object to add link to."),
	},
	Options: []cmds.Option{
